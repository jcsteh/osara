...
## Requirements
OSARA requires REAPER 6.41 or later.
...
- OSARA: Report current gain reduction for focused effect if supported
 - If no effect is focused, reports the gain reduction of the last focused effect.
- OSARA: About
